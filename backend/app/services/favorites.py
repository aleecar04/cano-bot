...
class FavoritesService:
    ...
    def add_favorite(self, fav_in: FavoriteActionCreate, user_id: str) -> dict:
    ...
    async def execute_favorite(self, favorite_id: str, user_id: str) -> dict:
    ...
    def update_favorite(self, favorite_id: str, user_id: str, action: str, payload: dict, label: str | None) -> dict | None:
