...
The real `drivers` package is NOT mocked: its internal hardware deps
(tinytuya, aiowebostv, etc.) are stubbed below, but the package itself
must remain importable so tests/drivers/ can test it directly.
"""
import sys
...
sys.modules.setdefault("samsungtvws",       MagicMock())
